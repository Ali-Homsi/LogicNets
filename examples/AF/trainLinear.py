...
def train(model, datasets, train_cfg, options):
    ...
    for epoch in range(0, num_epochs):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            #flatten the data before feeding it through the network
            data = data.view(-1,5250)

            # print(data.shape) # torch.Size([1024, 5250])
...
if __name__ == "__main__":
    ...
    # Instantiate model
    # x, y = dataset['train'][0]
    model_cfg['input_length'] = 5250 #  5250 input if the dataset windowsize is 42 Sec, 1250 if the windowsize of the dataset is 10 sec.
