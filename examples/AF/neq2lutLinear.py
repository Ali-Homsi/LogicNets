...
from trainLinear import configs, model_config, dataset_config, test
from dataset import AtrialFibrillationDataset
from models import AtrialFibrillationNeqModel, AtrialFibrillationLutModel
...
if __name__ == "__main__":
    ...
    # Fetch the test set
    dataset = {}
    # dataset[args.dataset_split] = MNISTDataset(split=args.dataset_split)
    dataset[args.dataset_split] = AtrialFibrillationDataset(split=args.dataset_split)
    ...
    model_cfg['input_length'] = 5250 #len(x)
    model_cfg['output_length'] = 2 #len(y)
    ...
    lut_model = AtrialFibrillationLutModel(model_cfg)
